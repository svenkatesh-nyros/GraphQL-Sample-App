...
import {CommentList, Description, IconsGrid, ItemsList} from '../../common';
import {cityData, commData, desData, homeData, iconData, imageData, itemData} from './data.json';
...
class DetailsNh extends Component {
  constructor() {
    ...
    this.state = {
      ...
      rlike: {},
      staticData: {
        name: 'San Carlos, CA', npi: 'NPI: 901 (#10 in the area)',
  ...
  render() {
    let {
      reply, data, comment, save, activePage, activePage1, smodal, lmodal
      , activePage2, staticData, ques, like, replies, commentData, qlike, rlike
    } = this.state;
    return (
      <Layout search={true}>
        <Grid divided>
          <Grid.Row>
            <Grid.Column width={10}>
              ...
              <Segmant>
                <Title
                  name="Questions about this CIty"
                  size="medium"
                  floated="left"
                />
              </Segmant>
              ...
              <Segmant>
                ...
                <Wcomment name="onquestion" visibility={true} changeval={this.askQues} submit={this.onSubmit}/>
              </Segmant>
              <Segmant>
                <Divider/>
            ...
            <Grid.Column width={6}>
              ...
              <Segmant textAlign="left">
                <Title name="Top Neighborhoods in this City" size="medium"/>
                <ItemsList
                  id="neighborhoods"
                  itemData={homeData}
              ...
              <Segmant>
                <Title name="Top Agents for this City" size="medium"/>
                <ItemsList
                  id="agents"
                  itemData={itemData}
                  href="/ProfileRealtor"
              ...
              <Segmant>
                <Title name="Similar Cities" size="medium"/>
                <ItemsList itemData={cityData}
                  id="sale"
                  href="/DetailsCity"
                  getData={this.onGet}
                  prev={this.togglePrev}
